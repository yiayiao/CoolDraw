...
// CoolDrawDoc.cpp : CCoolDrawDoc 类的实现
//
...
// 缩略图的支持
void CCoolDrawDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CCoolDrawDoc::InitializeSearchContent()
{
...
void CCoolDrawDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
